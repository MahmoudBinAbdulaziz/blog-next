      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          <h1 className="text-3xl font font-semibold text-center my-7">
            About Mahmoud&apos;s Blog
          </h1>
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Mahmoud&apos;s Blog! Created by Mahmoud Abdulaziz, this
              blog serves as a personal platform to share his insights and ideas
              with the world. Mahmoud is an enthusiastic developer who enjoys
            ...
            <p>
              ...
              engineering, and programming languages. Mahmoud is continually
